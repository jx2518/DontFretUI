...
class ScrollProvider {
    ...
    autoScroll(deltaTime, scrollSpeed) {
   ...
   */
    scrollBy(dragVector) {
        ...
        const deltaX = this.scrollView.enableHorizontalScroll && this.isXOverflow
            ? dragVector.x
            : 0;
        const deltaY = this.scrollView.enableVerticalScroll && this.isYOverflow
            ? dragVector.y
            : 0;
